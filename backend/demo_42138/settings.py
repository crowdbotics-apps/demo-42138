"""
Django settings for demo_42138 project.
...
WSGI_APPLICATION = 'demo_42138.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_42138 API",
    "DESCRIPTION": "API documentation for demo_42138 App",
    "VERSION": "v1",
}
